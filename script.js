...
const playersMove = document.querySelector('.players');
const actionInfo = document.querySelector('.action_info');
const player_1 = document.querySelector('.player_1');
const player_2 = document.querySelector('.player_2');
const money = document.querySelectorAll('.money');
const playerCards = document.querySelectorAll('.player_cards');
const boardHouse = document.querySelectorAll('.board_house');
const buyHouse = document.querySelectorAll('.buy_house');
const buyHotel = document.querySelectorAll('.buy_hotel');
const buyStreet = document.querySelectorAll('.buy_street');
const cardsInfo = [
    {
        "id": 0,
        "name": "GO",
...
const boardPosition = ["1/ 1/ 2/ 2", "1/ 2/ 2/ 3", "1/ 3/ 2/ 4", "1/ 4/ 2/ 5", "1/ 5/ 2/ 6", "2/ 5/ 3/ 6", "3/ 5/ 4/ 6", "4/ 5/ 5/ 6", "5/ 5/ 6/ 6", "5/ 4/ 6/ 5", "5/ 3/ 6/ 4", "5/ 2/ 6/ 3", "5/ 1/ 6/ 2", "4/ 1/ 5/ 2", "3/ 1/ 4/ 2", "2/ 1/ 3/ 2"];
let canBuyStreet_1 = true;
let canBuyStreet_2 = true;
let canBuyHouse_1 = true;
let canBuyHouse_2 = true;
let canBuyHotel_1 = true;
let canBuyHotel_2 = true;
let player_1Index = 0;
let player_2Index = 0;
let player_1Money = 5000;
let player_2Money = 5000;
let player_1Streets = [];
let player_2Streets = [];
let player_1StreetsColor = [];
let player_2StreetsColor = [];
    ...
    cardsInfo.forEach((card) => {
        ...
        if (card.type === "property" && player_1Index === card.id) {
            ...
            if (player_2Streets.includes(card.name)) {
                // house rent
                if (!((_a = card.house) === null || _a === void 0 ? void 0 : _a.length)) {
                    // @ts-ignore
            ...
            // @ts-ignore
                ...
                if (!canBuyStreet_1 && player_1Money >= card.houseCost) {
                    let checkColorLength = [];
                    player_1StreetsColor.forEach((item) => {
                        if (item === card.color) {
        ...
        if (card.type === "property" && player_2Index === card.id) {
            ...
            // @ts-ignore
                ...
                if (!canBuyStreet_2 && player_2Money >= card.houseCost) {
                    let checkColorLength = [];
                    player_2StreetsColor.forEach((item) => {
                        if (item === card.color) {
                            checkColorLength.push(item);
                            console.log(checkColorLength);
